...
{
'title' : 'Drawer',
'short_description' : 'The Drawer widget is a side panel in Flutter, used for app navigation. It slides in from the side and is often triggered by the AppBar\'s menu icon.',
'description' : 'The Drawer widget in Flutter is a slide-in panel from the side of the screen, typically used for navigation. It allows users to access different sections or features of an app without cluttering the main interface. A Drawer is often paired with an AppBar to open and close it easily.',
},
{
'title': 'Expanded',
'short_description':
